...
namespace Persistence.Migrations
{
    ...
    [Migration("20211110005026_PostReplyPropertyNameModified")]
    partial class PostReplyPropertyNameModified
    {
            ...
            modelBuilder.Entity("Domain.PostReply", b =>
                {
                    ...
                    b.Property<int?>("TargetPostReplyId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.PostReply", b =>
                {
                    ...
                    b.HasOne("Domain.PostReply", "TargetPostReply")
                        .WithMany()
                        .HasForeignKey("TargetPostReplyId");

                    b.Navigation("ApplicationUser");

                    b.Navigation("Post");

                    b.Navigation("TargetPostReply");
                });
